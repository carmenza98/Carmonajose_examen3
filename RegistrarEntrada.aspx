<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistrarEntrada.aspx.cs" Inherits="RegistrarEntrada" %>
...
<body>
    <form id="form1" runat="server">
        <div class="form-container">
            <h2>Registrar Entrada de Viajero</h2>
            ...
            <div class="form-group">
                <asp:Label ID="lblFechaEntrada" runat="server" Text="Fecha de Entrada: (YYYY-MM-DD)"></asp:Label>
